            ...
            <div class="h-[685px] relative  px-2 py-3 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
              ...
              <div class="mt-4 px-5 pb-5">
                ...
                <div class=" mb-5 flex items-center justify-between">
                  <p class="text-xl justify-center mx-auto text-center  font-bold text-slate-900"> <span className='font-bold'>Price: $</span> {product.price}</p>
                </div>
                <button onClick={() => handleAddToCart(product)} class=" bottom-4 left-0 absolute  flex items-center w-full justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
